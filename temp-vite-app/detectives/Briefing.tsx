...
export default function Briefing({agent, onComplete}: {agent:string; onComplete:()=>void}) {
 ...
 return <section className="briefing-page">
  <figure className="federica-scene"><img src="/los-archivos-f/images/agente-federica.png" alt="La agente Federica de incógnito en el archivo del faro, con una carpeta confidencial y una radio"/><figcaption><span className="signal-dot"/> TRANSMISIÓN CONFIDENCIAL <b>AGENTE FEDERICA · AGENCIA F</b></figcaption></figure>
