        ...
        <div className="investigation-panel">
          ...
          {level >= 2 && level <= 7 && (() => {
            ...
            return <section className="level-card">
              ...
              {level === 6 && !unlocked && <div className="level-mission"><span>MISIÓN DEL NIVEL</span><p>Descubrir el orden de lectura de las cinco banderas y reconstruir su mensaje.</p></div>}
