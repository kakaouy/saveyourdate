...
const AuroraInvitation = React.lazy(() => import('./components/aurora/AuroraInvitation').then((module) => ({ default: module.AuroraInvitation })));
const RosewoodInvitation = React.lazy(() => import('./components/rosewood/RosewoodInvitation').then((module) => ({ default: module.RosewoodInvitation })));
        ...
        <header className="admin-header">
          <div className="container admin-header-container">
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              ...
              <a className="btn-secondary" href="/?builder=aurora" style={{ padding: '6px 16px', borderRadius: '20px', fontSize: '13px', textDecoration: 'none' }}>
                ✨ Armá tu invitación
              </a>
                        ...
                        <div className="model-phone-screen">
                          {model.previewImage ? (
                            ...
                            <img
                              ...
                              src="/demos/boda-elegante-minimalista/assets/images/galeria/foto-01.jpg"
                              alt="Preview de Editorial Marfil"
                            />
                          ) : model.id === 'boda-pleno' ? (
                            <img
                              className="editorial-marfil-preview-image"
                              src="/previews/jardin-floral.jpg"
